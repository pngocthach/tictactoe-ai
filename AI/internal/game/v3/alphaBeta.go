...
func deepCloneDist(dist [][]int) [][]int {
	if dist == nil {
		return nil
	}
...
func deepCloneIntSlice(src []int) []int {
	if src == nil {
		return nil
	}
...
func (t *TicTacToe) deepClone() TicTacToe {
	return TicTacToe{
		...
		BoardRow:  deepCloneIntSlice(t.BoardRow),
		BoardCol:  deepCloneIntSlice(t.BoardCol),
		Dist:      deepCloneDist(t.Dist),
